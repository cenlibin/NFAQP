...
class MonteCarloAQP:
    ...
    def __init__(
        ...
        print("\nMonte Carlo AQP n_sample_points:{} n_chunks:{}".format(n_sample_points, n_each_chunks))
        self.pdf = pdf
        # self.n_sample_points = n_sample_points
        self.n_chunks = n_sample_points // n_each_chunks
        self.n_sample_points = n_each_chunks * self.n_chunks
        self.device = device
