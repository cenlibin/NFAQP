...
MODEL_PATH = "/home/clb/AQP/models/BJAQ-flow/best.pt"
DATASET_NAME = 'BJAQ'
APLHAS = [0.2, 0.4, 0.5, 0.7, 0.8]
BETAS = [0.2, 0.4, 0.5, 0.7, 0.8]
...
def eval():
    ...
    for idx, query in enumerate(queries):
        ...
        print(f'\nquery {idx}:{query} selectivity:{100 * sel_real:.3f}% lantency:{ms:.3f} ms')
